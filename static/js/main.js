...
(function($) {
    ...
    if ( _mainJS ) {
        ...
        if ( document.querySelector('[data-wrapper="letters-effect"]') ) {
          ...
          ease_js.src    = 'static/js/ease.js';
          letters_js.src = 'static/js/letters.js';
          segment_js.src = 'static/js/segment.min.js';
          mo_js.src      = 'static/js/mo.min.js';
          effects.src    = 'static/js/effects.js';
        ...
        if ( document.querySelector('[data-animated-background]') ) {
            ...
            TweenMax_js.src = 'static/js/TweenMax.min.js';
            ...
            if ( (document.querySelector('[data-animated-background="effect-4"]')) ) {
                ...
                three_js.src  = 'static/js/three.min.js';
                perlin_js.src = 'static/js/perlin.js';
            ...
            window.addEventListener('load', function () {
                ...
                if ( document.querySelector('[data-animated-background="effect-4"]') ) {
                  ...
                  bg_effect_4_js.src = 'static/js/effect-4.js';
